...
OMNIGLOT_DATA_DIR  = os.path.join(os.path.dirname(__file__), '/MLStamps/few-shot/prototypical-networks/data/omniglot')
OMNIGLOT_CACHE = { }
...
def load_class_images(d):
    if d['class'] not in OMNIGLOT_CACHE:
        ...
        image_dir = os.path.join(OMNIGLOT_DATA_DIR, 'data', character)
        #print(image_dir)
