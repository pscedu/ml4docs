...
default_model_path = 'results/best_model_2.pt'
...
parser.add_argument('--data.test_query', type=int, default=1, metavar='TESTQUERY',
                    help="number of query examples per class in test. 0 means same as model's data.query (default: 0)")
parser.add_argument('--data.test_episodes', type=int, default=2000, metavar='NTEST',
                    help="number of test episodes per epoch (default: 1000)")

args = vars(parser.parse_args())

main(args, inference=True)
