    ...
    def _generate_matches_pairs(self):
        ...
        for name in os.listdir(self.data_dir):
            ...
            with open(self.pairs_filepath, "a") as f:
                for i in range(3):
                    temp = random.choice(a)  # This line may vary depending on how your images are named.
                    w = temp
                    l = random.choice(a).rstrip(self.img_ext)
                    r = random.choice(a).rstrip(self.img_ext)
                    f.write(name + "\t" + l + "\t" + r + "\n")
    ...
    def _generate_mismatches_pairs(self):
        ...
        for i, name in enumerate(os.listdir(self.data_dir)):
            ...
            with open(self.pairs_filepath, "a") as f:
                ...
                f.write(name + "\t" + file1.rstrip(self.img_ext) + "\t" +  other_dir + "\t" + file2.rstrip(self.img_ext) +"\t")
                f.write("\n")


if __name__ == '__main__':
    data_dir = "/stamps-dataset_2/"
    pairs_filepath = "stamps_pairs.txt"
    img_ext = ".jpg"
